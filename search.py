...
AMADEUS_THROTTLE_SECONDS = float(os.getenv("AMADEUS_THROTTLE_SECONDS", "0.25"))
...
def _normalize_profile(profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # steps
    p["dep_step_days"] = int(_pick_first(p, ["dep_step_days", "depStep", "departure_step_days"]) or 10)
